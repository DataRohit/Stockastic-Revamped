...
# Function to test the dashboard home view when the user is unauthenticated
@pytest.mark.django_db
def test_dashboard_home_view_unauthenticated(client):
    # Get the dashboard home page
...
@pytest.mark.django_db
def test_dashboard_home_view_authenticated(client, user):
