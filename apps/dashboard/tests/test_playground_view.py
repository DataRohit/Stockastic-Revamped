...
# Function to test the playground view when the user is unauthenticated
@pytest.mark.django_db
def test_playground_view_unauthenticated(client):
    # Get the playground page
    response = client.get(reverse("dashboard:playground"))
...
# Function to test the playground view when the user is authenticated
@pytest.mark.django_db
def test_playground_view_authenticated(client, user):
    ...
    # Assert the correct template is used
    assertTemplateUsed(response, "dashboard/playground.html")
