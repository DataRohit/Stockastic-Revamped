...
if __name__ == "__main__":
    ...
    try:
        ...
        # Raise an ImportError if the execute_from_command_line function is not found
        raise ImportError(
            "Couldn't import Django's execute_from_command_line. Are you sure you "
            "don't need to use `django-admin` or `manage.py`?"
        )
